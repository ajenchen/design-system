  ...
  render: () => {
    ...
    <div className="flex flex-col gap-12">
      ...
      <ul className="space-y-1">
        <li>
          <LinkTo kind="Design System/Components/Slider/展示" name="範圍模式"><span className="text-primary hover:underline font-medium cursor-pointer">範圍模式</span></LinkTo>
        </li>
        <li>
        ...
        <li>
          <LinkTo kind="Design System/Components/Slider/展示" name="Min / Max / Step"><span className="text-primary hover:underline font-medium cursor-pointer">Min / Max / Step</span></LinkTo>
        </li>
        <li>
          <LinkTo kind="Design System/Components/Slider/展示" name="On Value Commit"><span className="text-primary hover:underline font-medium cursor-pointer">On Value Commit</span></LinkTo>
        </li>
      </ul>
