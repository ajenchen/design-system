...
- 某 bug 跟 11 條中任一條對不上 → 可能要新增第 12 條(跟 user 討論)
...
| Meta-Pattern 數 | M1-M9 逐漸擴充,新條目代表根因發現 |
...
**判 bug 該寫哪**:
- 能歸納為 Meta-Pattern M1-M9 之一 → 不寫本索引(已被 meta 吸收)
...
- **新 bug 確認後**:先判能否歸 Meta-Pattern M1-M9。能 → 不寫本索引(meta 已吸收);不能 → 一行 anchor + 對應章節 pointer
