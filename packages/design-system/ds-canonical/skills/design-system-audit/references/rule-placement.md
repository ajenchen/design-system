...
| Spec 寫作要交叉比對 | CLAUDE.md 或 spec 或 Hook | **M3 mindset #3**(`pre_edit_spec_check.sh` retired,現居 `.claude/hooks/retired/`;`check_sync_update.sh` retired/未實作)| Edit 前讀 spec + mindset 連動 |
