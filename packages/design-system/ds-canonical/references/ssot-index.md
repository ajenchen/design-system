...
| **Protected solo workflow**(1 task = 1 branch + 1 PR / required CI / standing engineering delegation)| `feedback_solo_dev_workflow.md` + AGENTS.md「Git solo-work canonical」 | protected main 禁 direct push；PR 建立正常；checks/conversations/preview/readback 全綠後自主 merge；tag 綁 preflight commit/tree | ✅ aligned(M28 + hooks + GitHub ruleset)| 2026-07-20 migration / 2026-07-26 authority reconciliation |
