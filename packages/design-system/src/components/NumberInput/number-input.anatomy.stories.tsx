    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <SegmentedControl size="sm" aria-label="Error" value={error ? 'on' : 'off'} onValueChange={(v) => setError(v === 'on')}>
        ...
        <div className="flex items-center gap-2">
          ...
          <SegmentedControl size="sm" aria-label="Prefix" value={hasPrefix ? 'on' : 'off'} onValueChange={(v) => setHasPrefix(v === 'on')}>
            <SegmentedControlItem value="off">off</SegmentedControlItem>
            <SegmentedControlItem value="on">$</SegmentedControlItem>
          </SegmentedControl>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-fg-muted w-16 shrink-0">endAction</span>
          <SegmentedControl size="sm" aria-label="endAction" value={hasEndAction ? 'on' : 'off'} onValueChange={(v) => setHasEndAction(v === 'on')}>
            <SegmentedControlItem value="off">off</SegmentedControlItem>
            <SegmentedControlItem value="on">on</SegmentedControlItem>
          </SegmentedControl>
