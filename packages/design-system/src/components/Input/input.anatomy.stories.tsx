      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="w-[300px] shrink-0 border border-divider rounded-lg bg-surface overflow-hidden">
          ...
          <div className="px-4 py-1 pb-3">
            ...
            <PropRow label="Focus"><TkVal token="border-primary" value="1px — 無外框（readonly 例外:全域外描邊 2px --ring 往外 2px,WCAG 2.4.7）" /></PropRow>
  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-8">
        ...
        {/* Focus behavior */}
        <div className="flex flex-col gap-4">
          <span className="text-caption font-medium text-fg-secondary">Focus — border-primary（1px），無外框（readonly 例外:全域外描邊,往外 2px,WCAG 2.4.7）</span>
