    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex items-center gap-2">
          ...
          <SegmentedControl size="sm" aria-label="Checked" value={checked} onValueChange={(v) => setChecked(v as CheckedKey)}>
            {CHECKED_STATES.map((c) => <SegmentedControlItem key={c} value={c}>{c}</SegmentedControlItem>)}
          </SegmentedControl>
        </div>
        <div className="flex items-center gap-2">
