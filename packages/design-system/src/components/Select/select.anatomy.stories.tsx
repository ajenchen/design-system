          ...
          <table className="text-caption border-collapse">
            ...
            <tbody>
              {[
                ...
                ['loading', 'boolean', 'false', '載入中(2026-09-08 user 改決定):觸發點右側、箭頭左邊放列圖示尺寸的轉圈,每次抓資料都亮;選單內只在沒有任何可顯示選項時渲一列「載入選項中」訊息列(與一筆結果等高),舊選項保留不清空、選單不關'],
                ['emptyText', 'string', "'沒有選項'", '選單裡沒有可顯示選項時的訊息列文案(打開就沒選項與搜尋無結果共用;一句到底、可覆寫)'],
