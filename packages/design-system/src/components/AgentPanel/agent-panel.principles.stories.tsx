    ...
    <article className="max-w-2xl space-y-6 text-body text-foreground">
      ...
      <section>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-fg-secondary">
          ...
          <li>入口鈕只有「家」(右下角 40 圓鈕)與「貼邊」(右緣中線以下 28 半圓,只有高度可調)兩種位置;拖 40 圓鈕時右緣帶(寬 36、從視窗中線到家上方一個 loose)亮出藍色底(primary-subtle,貼右緣、內側圓角),進帶預覽就貼在右緣、放開落定,帶外放開飛回家;兩種形態點一下都直接開面板;位置由產品端受控保存。</li>
