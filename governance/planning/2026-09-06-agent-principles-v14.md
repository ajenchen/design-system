...
| **B** | 呈現 | agent 開啟且無全域阻擋時,**寬螢幕**讓具資格的內容與 agent **並列可操作**;**窄螢幕**以抽屜覆蓋宿主(左留視窗內距 `--layout-space-viewport-inset`、底下鋪遮罩;遮罩只提示、點了不關,2026-09-16,見「來源總帳」),宿主暫不可操作;**窄螢幕下從 agent 導向宿主的動作(內部連結、有 URL 的 Modal、確認前往)讓 agent 收成入口鈕、宿主顯示目標**(2026-09-09,見「來源總帳」)。 |
...
| 窄螢幕要不要兩邊都能用 | 已答 —— 不要,窄螢幕抽屜覆蓋宿主(2026-09-16 起左留 48px 內距、底下鋪遮罩、遮罩點了不關;見「來源總帳(2026-09-16)」) |
