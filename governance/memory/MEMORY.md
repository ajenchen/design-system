...
- [project_provider_neutral_governance.md](project_provider_neutral_governance.md) — PNG SHIPPED(07-29):beta.95/96 OIDC+provenance 發版 + 鏈硬化(冪等/重試/隔離);machine contracts 是 authority、provider views 生成;殘留 3 項 owner 動作
