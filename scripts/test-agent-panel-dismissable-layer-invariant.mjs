#!/usr/bin/env node
// meta-test for agent-panel-dismissable-layer-invariant —— 現況必綠 + 對照組(--selftest 注入合成違規)必紅。
//
...
runGateSelftestMeta('scripts/agent-panel-dismissable-layer-invariant.mjs')
