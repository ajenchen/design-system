...
const run = () => spawnSync(process.execPath, ['--', 'scripts/layout-space-utility-invariant.mjs'], { stdio: 'pipe' }).status ?? 1
let ok = true

// 1) 現況必 PASS
if (run() !== 0) { console.error('✗ baseline run 應 PASS 卻 FAIL(repo 已有真違規 → 換乾淨 target)'); process.exit(1) }
