#!/usr/bin/env node
// meta-test for provider-view-group-reachability-invariant —— 現況必綠 + 對照組(--selftest 注入合成違規)必紅。
//
...
runGateSelftestMeta('scripts/provider-view-group-reachability-invariant.mjs')
