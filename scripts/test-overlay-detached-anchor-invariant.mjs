...
const run = (args) => spawnSync(process.execPath, ['scripts/overlay-detached-anchor-invariant.mjs', ...args], { stdio: 'pipe', encoding: 'utf8' })
const base = run([])
