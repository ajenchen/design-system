...
const WHITE_ALPHAS = [0.04, 0.08, 0.12, 0.15, 0.25, 0.45, 0.65, 0.85]

const NEUTRAL_LIGHT_ALPHA = { 1: 0.02, 2: 0.04, 3: 0.06, 4: 0.09, 5: 0.15, 6: 0.25, 7: 0.45, 8: 0.85, 9: 0.98 }
const NEUTRAL_DARK_ALPHA  = { 1: 0.04, 2: 0.08, 3: 0.12, 4: 0.15, 5: 0.25, 6: 0.45, 7: 0.65, 8: 0.85, 9: 0.98 }

const NEUTRAL_LIGHT_OPAQUE = { 1: 0.98, 2: 0.96, 3: 0.94, 4: 0.91, 5: 0.85, 6: 0.78, 7: 0.55, 8: 0.36, 9: 0.18 }
const NEUTRAL_DARK_OPAQUE  = { 1: 0.04, 2: 0.08, 3: 0.12, 4: 0.15, 5: 0.25, 6: 0.45, 7: 0.65, 8: 0.85, 9: 0.98 }
