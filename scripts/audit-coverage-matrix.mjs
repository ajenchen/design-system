...
const COVERAGE = {
  ...
  64: { tier: 'CI-ENFORCED', mechanism: 'protected-main PR + exact release attestation + mirror/fleet PR propagation;no direct-main or mutable dispatch path' },
  ...
  66: { tier: 'CI-ENFORCED', mechanism: 'Release workflow_run → GitHub App mirror PR + consumer required audit/visual checks;no PAT/direct-main dispatch' },
