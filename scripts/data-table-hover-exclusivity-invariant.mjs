...
const browser = await launchBrowser(); const page = await browser.newPage({ viewport: { width: 1400, height: 800 } })
...
for (const c of CASES) {
  await page.goto(`http://127.0.0.1:${port}/iframe.html?id=${encodeURIComponent(STORY)}&viewMode=story`, { waitUntil: 'load', timeout: 90000 })
