#!/usr/bin/env node
// meta-test for data-table-row-under-pointer-invariant —— 現況必綠 + 對照組(--selftest 注入合成違規)必紅。
//
...
runGateSelftestMeta('scripts/data-table-row-under-pointer-invariant.mjs')
