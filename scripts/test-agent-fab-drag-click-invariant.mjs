...
const run = (args) => spawnSync(process.execPath, ['scripts/agent-fab-drag-click-invariant.mjs', ...args], { stdio: 'pipe', encoding: 'utf8' })
const base = run([])
