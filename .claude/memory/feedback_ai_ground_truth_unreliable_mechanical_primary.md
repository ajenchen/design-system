...
3. **Visual diff supplementary**:`scripts/composition-fidelity-visual-diff.mjs` v4 dual-track(pixel + DOM signature)— pixel adequate for same-content;DOM signature for structural;UNION semantics
